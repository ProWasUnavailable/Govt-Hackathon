...
import '/components/p_d_fdisplay_widget.dart';
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        context.pushNamed('updatingstuff');
                                      },
                                      text: 'Add/Update',
                                      options: FFButtonOptions(
                                        width: 150.0,
                  ...
                  children: [
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: Align(
                          alignment: const AlignmentDirectional(0.0, -1.0),
                          child: StreamBuilder<List<DocumentIDRecord>>(
                            stream: queryDocumentIDRecord(
                              queryBuilder: (documentIDRecord) =>
                                  documentIDRecord.whereIn('documentType',
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<DocumentIDRecord>
                                  listViewDocumentIDRecordList = snapshot.data!;

                              return ListView.separated(
                                padding: EdgeInsets.zero,
                                shrinkWrap: true,
                                scrollDirection: Axis.vertical,
                                itemCount: listViewDocumentIDRecordList.length,
                                separatorBuilder: (_, __) =>
                                    const SizedBox(height: 10.0),
                                itemBuilder: (context, listViewIndex) {
                                  final listViewDocumentIDRecord =
                                      listViewDocumentIDRecordList[
                                          listViewIndex];
                                  return Align(
                                    alignment: const AlignmentDirectional(0.0, -1.0),
                                    child: Padding(
